    ...
    mockGetDiseasesForCrop.mockReturnValue([
      {
        ...
        symptoms: ['mosaic pattern on leaves', 'yellow leaves', 'curled leaves'],
        causes: ['Virus'],
        severity: 'high',
      ...
      },
      {
        ...
        cropId: 'cassava',
        name: 'Cassava Blight',
        description: 'Bacterial disease causing leaf blight.',
        symptoms: ['yellow leaves', 'brown spots', 'leaf curling'],
        causes: ['Bacteria'],
        severity: 'high',
        treatments: ['Remove infected plants'],
        prevention: ['Use disease-free cuttings'],
        aliases: [],
        references: [],
      },
      {
        id: 'cassava-yellow-mottle',
        cropId: 'cassava',
        name: 'Cassava Yellow Mottle',
        description: 'Viral disease causing yellow mottling.',
        symptoms: ['yellow mottling', 'mosaic pattern', 'stunted growth'],
        causes: ['Virus'],
        severity: 'moderate',
        treatments: ['Remove infected plants'],
  ...
  it('returns knowledge response when AI fails', async () => {
    ...
    mockGetDiseasesForCrop.mockReturnValue([
      ...
      },
      {
        ...
        symptoms: ['brown spots', 'yellow leaves', 'curled leaves'],
        causes: ['Bacteria'],
        severity: 'high',
        treatments: ['Remove infected plants'],
        prevention: ['Use disease-free cuttings'],
    ...
    const response = await engine.answerDiagnosis({
      request: { symptoms: 'mosaic yellow leaves curled', cropId: 'cassava' },
    });
